...
console.log(arr.slice(2, 4)); // ['c', 'd', 'e']
...
// Splice => Remove element in array (safe way use toSplice())
...
// Reverse => Mutate (safe way use toReversed())
arr = ['a', 'b', 'c', 'd', 'e'];
...
// The new at() method => Returns an indexed element from an array
...
// some: condition => Returns true if some elements pass a test
console.log(movements.some(mov => mov === -130)); // true

const anyDeposits = movements.some(mov => mov > 0);
console.log(anyDeposits); // true

// every => Returns true if every elements pass a test
...
///////////////////////////////////////
// flat and flatMap
// flat => Creates a new array from sub-array elements
...
// Strings => Mutate (better safe way use toSorted())
const owners = ['Ridho', 'Syamsudin', 'Rosidah Lia', 'Handika'];
...
const arrWithNewArray = new Array(1, 2, 3, 4, 5, 6, 7);
console.log(arrWithNewArray);
